...
<script>
import DeleteVeggieRecipeDialog from '../dialogs/veggieRecipes-dialogs/DeleteVeggieRecipeDialog';
import UpdateVeggieRecipeDialog from '../dialogs/veggieRecipes-dialogs/UpdateVeggieRecipeDialog';
...
export default {
  components: {
    ...
    'app-update-veggie-recipe-dialog': UpdateVeggieRecipeDialog,
  ...
  computed: {
    ...
    filteredRecipes() {
      return this.veggieCollection.filter((item) => {
  ...
  mounted() {
    this.$store.dispatch("getVeggieCollection");
  },
};
</script>
